...
public class GemLoreConfigManager extends AbstractConfigManager {
    ...
    public void createDefaultLore(String gemName) {
        ...
        switch (gemName) {
            ...
            break;
            case "Admin":
                lore.add(ChatColor.WHITE + "Right click: Kicks all players within a 10 block radius.");
                lore.add(ChatColor.WHITE + "Shift click: Give yourself Resistance 255 for 1 minute.");
                lore.add(ChatColor.WHITE + "Left click: Gives all players within a 10 block radius Weakness and Poison 255 for a minute.");
                break;
            default:
