...
public class FireGem extends Gem {
    ...
    protected void rightClick(Player plr) {
        ...
        plr.addPotionEffect(new PotionEffect(PotionEffectType.FIRE_RESISTANCE, 30 * (secondMultiplier), 1));
    ...
    protected void leftClick(Player plr) {
        Location playerLocation = plr.getLocation();
        World world = plr.getWorld();
        plr.addPotionEffect(new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 10 * (secondMultiplier), 5));
        plr.addPotionEffect(new PotionEffect(PotionEffectType.FIRE_RESISTANCE, 10 * (secondMultiplier), 1));
